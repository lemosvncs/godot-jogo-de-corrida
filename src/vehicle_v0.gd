...
func get_rpm(gear:int, rotation_rate):
	...
	pass
func slip_ratio(wheel_angular_velocity, wheel_radius, speed):
	#var slip_ratio = (wheel_angular_velocity*wheel_radius - speed)/abs(speed)
	pass
func _ready() -> void:
	# Setup the body
